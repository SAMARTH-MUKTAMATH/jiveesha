# PHASE 3-P2: SETTINGS & ACCOUNT MANAGEMENT
## Build User Settings, Profile Management & Account Controls

**Prompt ID:** 3-P2  
**Phase:** 3 - Parent Portal Frontend  
**Section:** P - Resources & Settings  
**Dependencies:** 3-P1 complete (Resource Library working)  
...
Create the settings page where parents can:
- **Profile Settings**: Edit name, email, phone, photo
- **Account Security**: Change password, enable 2FA (placeholder)
- **Notification Preferences**: Email/SMS notifications for different events
- **Privacy Settings**: Data sharing preferences, consent visibility
- **Language & Region**: Select preferred language (multilingual support ready)
- **Help & Support**: Access help center, contact support, FAQs
- **Account Management**: Export data, delete account
- Responsive tabbed layout

**Settings Sections:**
1. **👤 Profile** - Personal information
2. **🔒 Security** - Password and authentication
3. **🔔 Notifications** - Email/SMS preferences
4. **🔐 Privacy** - Data sharing and consent
5. **🌍 Preferences** - Language, timezone, theme
6. **❓ Help & Support** - Resources and contact
7. **⚙️ Account** - Data export, account deletion
...
class SettingsService {
  ...
  async updatePassword(data: UpdatePasswordData): Promise<{ success: boolean }> {
    const response = await api.put('/parent/profile/password', data);
    return response.data;
  }
...
### Step 3: Update App.tsx with Settings Route
...
### Step 4: Update Layout to Add Settings Link

**File:** `src/components/Layout.tsx`

**Action:** ADD settings link to user menu or navigation:

In the user dropdown/menu, add:
```typescript
<button
  onClick={() => navigate('/settings')}
  className="flex items-center gap-2 px-4 py-2 hover:bg-slate-100 transition-colors"
>
  <Settings size={18} />
  <span>Settings</span>
</button>
...
2. See settings page with tabs
3. Click each tab
4. **Profile**: Edit name, email, phone, upload photo
5. **Security**: Change password
6. **Notifications**: Toggle preferences
7. **Privacy**: Toggle data sharing
8. **Preferences**: Change language, timezone
9. **Help**: View support links
10. **Account**: Export data, delete account
11. Test save on each tab
...
3. ✅ Tabbed interface works
4. ✅ Profile editing works
5. ✅ Photo upload works
6. ✅ Password change works
7. ✅ Notification toggles work
8. ✅ Privacy toggles work
9. ✅ Preferences dropdowns work
10. ✅ Help links work
11. ✅ Export data works
12. ✅ Delete account works
13. ✅ Success/error messages display
...
## 🎉 CORE PARENT PORTAL NOW COMPLETE!

After this prompt, you will have completed **all core Parent Portal features**:
...
- ✅ P: Resources & Settings (2 prompts) ← COMPLETE!

**Total Progress:** 19/20 prompts = 95% complete!

**Remaining:** 1 bonus prompt
- Q1: Journal Feature (Unified PEP + General)

---

## ⏭️ NEXT & FINAL PROMPT

**PHASE_3-Q1** - Journal Feature (Unified System)
...
**Mark complete and proceed to 3-Q1 (FINAL BONUS PROMPT!)** ✅
