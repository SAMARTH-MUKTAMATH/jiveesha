            ...
            {steps.map((s) => (
              <div key={s.id} className="relative z-10 flex flex-col items-center">
                ...
                <span className={`text-[10px] font-black uppercase tracking-widest mt-3 transition-colors ${
                  currentStep === s.id ? 'text-[#2563EB]' : 'text-slate-400'
                }`}>
                  {s.id}. {s.label}
                </span>
              </div>
        ...
        <div className="max-w-[1440px] mx-auto h-full flex items-center justify-between">
           ...
           <div className="flex items-center gap-4">
              ...
              <button 
                ...
                className={`h-14 px-12 rounded-2xl text-sm font-black uppercase tracking-[0.1em] shadow-2xl transition-all active:scale-95 flex items-center gap-3 ${
                  currentStep === 5 && !clinicianSigned 
