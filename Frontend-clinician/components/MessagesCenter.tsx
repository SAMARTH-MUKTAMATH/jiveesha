...
const MessagesCenter: React.FC<MessagesCenterProps> = ({ onBack, onNavigate }) => {
               ...
               <div className="flex items-center gap-4">
                  ...
                  <div>
                     ...
                     <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => onNavigate?.('profile', 'aarav')} className="text-[10px] font-bold text-[#2563EB] hover:underline flex items-center gap-1">View Profile <ChevronRight size={10} /></button>
                     </div>
                  </div>
               </div>
               <div className="flex items-center gap-2">
                  ...
                  return (
                     <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'} group`}>
                        ...
                        <div className={`max-w-[70%] ${isMe ? 'items-end' : 'items-start'} flex flex-col`}>
                           ...
                           <div className={`p-4 rounded-2xl text-sm font-medium leading-relaxed relative shadow-sm ${isMe ? 'bg-[#2563EB] text-white rounded-tr-none' :
